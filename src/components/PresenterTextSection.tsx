        ...
        <div className="rounded-3xl bg-white shadow-sm border border-black/5 overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="order-1 lg:order-2 p-8 lg:p-10 bg-[#faf7ef]">
              ...
              >
                یہ بابرکت کتاب سیدہ محمدی بیگم (لَطَفَ اللّٰهُ بِھَا وَ حَفِظَہَا) کی پیشکش ہے، جو محدثِ دکن ابوالحسنات حضرت سید عبداللہ شاہ نقشبندی قادری رحمۃ اللہ علیہ کی نواسی ہیں۔
              </p>
